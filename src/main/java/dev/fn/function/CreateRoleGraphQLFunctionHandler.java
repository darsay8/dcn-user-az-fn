...
@Component
public class CreateRoleGraphQLFunctionHandler {

  private final GraphQL graphQL;

  public CreateRoleGraphQLFunctionHandler(GraphQL graphQL) {
    this.graphQL = graphQL;
  }

  @FunctionName("createRoleFunctionGraphQL")
  public HttpResponseMessage execute(
    ...
    context.getLogger().info("GraphQL mutation: " + query);
